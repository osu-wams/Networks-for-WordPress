...
function networks_check_domain() {
    ...
    <div id="network_verify_result">
        ...
        <ul>
            <li class="<?php echo $dns_result_class ?>">
                DNS: <?php echo $dns_result; ?></li>
            <li class="<?php echo $site_result_class ?>">
                Domain: <?php echo $site_result; ?></li>
            <li class="<?php echo $path_result_class ?>">
                Path: <?php echo $path_result; ?></li>
        </ul>
    </div>
	<?php
	die();
