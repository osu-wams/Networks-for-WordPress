<?php
/**
 * This file has fixes and tweaks to make life easier for admins running
 * multiple Network installs. Most of these apply only to specific situations,
 * but they are safe for any install. These do not need the rest of Networks
 * for Wordpress to be installed or activated. Feel free to copy this file into
 * your muplugins directory to ensure continuity during plugin upgrades.
 */
